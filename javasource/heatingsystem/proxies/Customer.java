...
public class Customer extends administration.proxies.Account
{
	 ...
	 */
	public static final java.lang.String entityName = "HeatingSystem.Customer";
	...
	public static heatingsystem.proxies.Customer initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return heatingsystem.proxies.Customer.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static heatingsystem.proxies.Customer initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new heatingsystem.proxies.Customer(context, mendixObject);
	}

	public static heatingsystem.proxies.Customer load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return heatingsystem.proxies.Customer.initialize(context, mendixObject);
	}

	public static java.util.List<heatingsystem.proxies.Customer> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> heatingsystem.proxies.Customer.initialize(context, obj))
	...
	/**
	 * @return value of CustomerEdit
	 */
	public final java.lang.Boolean getCustomerEdit()
	{
		return getCustomerEdit(getContext());
	}
	 ...
	 * @return value of CustomerEdit
	 */
	public final java.lang.Boolean getCustomerEdit(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Boolean) getMendixObject().getValue(context, MemberNames.CustomerEdit.toString());
	}

	/**
	 * Set value of CustomerEdit
	 * @param customeredit
	 */
	public final void setCustomerEdit(java.lang.Boolean customeredit)
	{
		setCustomerEdit(getContext(), customeredit);
	}
	 ...
	 * @param customeredit
	 */
	public final void setCustomerEdit(com.mendix.systemwideinterfaces.core.IContext context, java.lang.Boolean customeredit)
	{
		getMendixObject().setValue(context, MemberNames.CustomerEdit.toString(), customeredit);
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final heatingsystem.proxies.Customer that = (heatingsystem.proxies.Customer) obj;
